...
namespace NeuralNetworkTutorialApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            sWatch.Start();
             GMDH lvq = new GMDH(inputs, Normalize.FormAnswersLVQ(answers), MIN_ERROR, LEARNING_RATE2, DECAY_RATE, NUM_OF_CLUSTERS);
            sWatch.Stop();
            ...
            lvq.Save(@"d:\Навчання\test_network2.xml");
             ...
             GMDH lvq2 = new GMDH(@"d:\Навчання\test_network2.xml");
